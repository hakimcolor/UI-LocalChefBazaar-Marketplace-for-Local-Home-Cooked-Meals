...
//         const emailPart = email.substring(0, 3).toLowerCase(); // email এর প্রথম 3 অক্ষর
//         const lengthPart = foodName.length; // foodName এর length
//         const timestamp = Date.now().toString().slice(-4); // শেষ 4 digit timestamp
...
//         chefId: chefId, // auto-generated chefId
